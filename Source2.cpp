...
//
//Ứng với thao tác tìm kiếm đỉnh lân cận của 02 đỉnh, xuất ra màn hình trên cùng một dòng thứ tự của các đỉnh kề với đỉnh thứ u, 
//các đỉnh xuất theo thứ tự tăng dần, cách nhau bởi khoảng trắng.Nếu không có đỉnh nào kề với đỉnh thứ u xuất ra chuỗi NONE
#include<iostream>
using namespace std;
int main()
{
